...
<title>Welcome to the Home Page!</title>
    <link href="<c:url value='/area/fontawesome-5.5/css/all.min.css'/>" rel="stylesheet">
    <link href="<c:url value='/area/slick/slick.css'/>" rel="stylesheet">
    <link href="<c:url value='/area/slick/slick-theme.css"'/>" rel="stylesheet" >
    <link href="<c:url value='/area/magnific-popup/magnific-popup.css'/>" rel="stylesheet" >
    <link href="<c:url value='/area/css/bootstrap.min.css'/>" rel="stylesheet" >
    <link href="<c:url value='/area/css/templatemo-style.css'/>" rel="stylesheet" >
</head>
<body>    
    <!-- Hero section -->
    ...
    <section id="introduction" class="tm-section-pad-top">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <img src="<c:url value='/area/img/the-town-01.jpg'/>" alt="Image" class="img-fluid tm-intro-img" />
          </div>
          <div class="col-lg-6">
            ...
            <div class="col-12">
                <div class="mx-auto tm-gallery-container">
                    <div class="grid tm-gallery">
                      <a href="<c:url value='/area/img/gallery-img-01.jpg'/>">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="<c:url value='/area/img/gallery-tn-01.jpg'/>" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Dreamy <span>Honey</span> Now</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="<c:url value='/area/img/gallery-img-02.jpg'/>">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="<c:url value='/area/img/gallery-tn-02.jpg'/>" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Second <span>Honey</span> Now</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="<c:url value='/area/img/allery-img-03.jpg'/>">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="<c:url value='/area/img/gallery-tn-03.jpg'/>" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Third <span>Honey</span> Now</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="<c:url value='/area/img/gallery-img-04.jpg'/>">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="<c:url value='/area/img/gallery-tn-04.jpg'/>" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Dreamy <span>Honey</span> Now</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="<c:url value='/area/img/gallery-img-05.jpg'/>">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="<c:url value='/area/img/gallery-tn-05.jpg'/>" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Fifth <span>Honey</span> Now</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="<c:url value='/area/img/gallery-img-06.jpg'/>">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="<c:url value='/area/img/gallery-tn-06.jpg'/>" alt="Image" class="img-fluid">
                          <figcaption>
    ...
    <script type="text/javascript" src="<c:url value='/area/js/jquery-1.9.1.min.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/area/slick/slick.min.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/area/magnific-popup/jquery.magnific-popup.min.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/area/js/jquery.singlePageNav.min.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/area/js/bootstrap.min.js'/>"></script>
    <script>
