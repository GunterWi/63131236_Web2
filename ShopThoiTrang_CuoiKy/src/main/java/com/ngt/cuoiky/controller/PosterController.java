...
public class PosterController {
    ...
    public String savePoster(Poster poster, BindingResult errors, RedirectAttributes redirectAttributes, @RequestParam("file") MultipartFile file) throws Exception, IOException {
